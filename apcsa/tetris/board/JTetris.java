 ...
 * This code is provided in finished form for the students. See
...
public class JTetris extends JComponent {
    ...
    JTetris(int width, int height) {
        ...
        keyMap.put(KeyEvent.VK_UP, RIGHT);
        keyMap.put(KeyEvent.VK_SPACE, RIGHT);
        ...
        timer = new javax.swing.Timer(DELAY, (_) -> {
            tick(DOWN);
        });
    }
    ...
    /**
     * Tries to add a new random at the top of the board. Ends the game if it's
     * not possible.
     */
    ...
    /**
     * Creates the panel of UI controls. This code is very repetitive -- the
     * GUI/XML extensions in Java 1.4 should make this sort of ugly code less
     * necessary.
     */
